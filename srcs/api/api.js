...
const IOTA_utils = require('../utils/IOTA_utils.js')
...
async function main () {
  app.listen(storage.http_port, function () {
    console.log('API listening on port', storage.http_port)
  })
...
}).listen(network.init_server(globValue.http_port, '127.0.0.1'));
let connection;
